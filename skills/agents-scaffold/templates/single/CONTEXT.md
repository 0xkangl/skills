...
The **ubiquitous language** of this project. These terms MUST be used consistently in specs, code, comments, and conversation.

**This file is a glossary and nothing else.** No implementation details, no specifications, no scratch notes — those belong under `docs/`. A glossary that accumulates implementation detail drifts with the code and stops being usable as a reference.
