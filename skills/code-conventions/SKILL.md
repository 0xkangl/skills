...
| 部署 / 发版 | [references/deployment.md](references/deployment.md) | 所有可部署模块 | 发版前置资料清单、配置文件 `[env]` 与平台 secret 的归属判据、发版执行顺序与验证/回滚、Fly.io 与 Cloudflare(wrangler + API token) 两套方案 |
